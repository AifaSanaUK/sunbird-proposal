...
export const defaultProposal: ProposalData = {
  ...
  bom: [
    ...
    { particular: "DCDB", specification: "3KW 1 IN 1 OUT", make: "C&S/Havells/Finder" },
    ...
    { particular: "Backfill compound bag (chemical)", specification: "10 kg", make: "Excel/Equivalent" },
  ...
  exclusions: [
    ...
    "KSEB Registration Fee is Excluded (₹3540/-) (80% i.e. ₹2400/- refundable to the Customer from KSEB within 6 months after installation).",
